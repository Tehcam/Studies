...
/* harmony import */ var jquery_nested_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery_nested_form */ "./node_modules/jquery_nested_form/vendor/assets/javascripts/jquery_nested_form.js");
/* harmony import */ var jquery_nested_form__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery_nested_form__WEBPACK_IMPORTED_MODULE_0__);
...
window.jQuery = jquery__WEBPACK_IMPORTED_MODULE_1___default.a; // Uncomment to copy all static images under ../images to the output folder and reference
...
(function ($) {
  ...
  NestedFormEvents.prototype = {
    addFields: function addFields(e) {
      ...
      var context = ($(link).closest('.fields').closestChild('input, textarea, select').eq(0).attr('name') || '').replace(/\[[a-z_]+\]$/, ''); // If the parent has no inputs we need to strip off the last pair
...
/******/ });
//# sourceMappingURL=application-7ee9059c48ddd54b142a.js.map