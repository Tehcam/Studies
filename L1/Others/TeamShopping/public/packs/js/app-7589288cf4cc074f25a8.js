...
function postNotification(item, status) {
  var notification = {
    title: "TeamShopping",
    content: status ? item + " vient d'être acheté !" : "Il faut acheter : " + item + " !"
  };
  pubnub.publish({
...
$('.checkbox').on('click', function (e) {
  ...
  $.ajax({
    ...
    success: function success(res) {
      e.currentTarget.checked = bool;
      postNotification(res.label, res.is_already_bought);
    },
    dataType: 'json',
    data: mydata
  });
...
/******/ });
//# sourceMappingURL=app-7589288cf4cc074f25a8.js.map